  ...
  return (
    ...
    <div className='flex1'>
      <div className='cont1'>
        ...
        <h4 className='line'> we do not know how to love human.</h4>
      </div>
      <div className='cont2'>
        <div className='cont3'>
        <span className='imgtxt2 hhd1'>Since we do not love nature,</span>
        <h6 className='line1'> we do not know how to love human.</h6>
        </div>
        <div className='cont3'>
        <span className='imgtxt2 hhd1'>Since we do not love nature,</span>
        <h6 className='line1 ll1'> we do not know how to love human.</h6>
        </div>
      </div>
    </div>
    <br /><br />
